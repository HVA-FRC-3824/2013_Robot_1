...
public:
	...
	static SpeedController* drivetrainBackRight;
	...
	static AnalogChannel* shooterShooterAngleChecker;
	static SpeedController* shooterShooterFinger;
	static Relay* shooterFeederSpike;
	static DigitalInput* shooterFeederSwitch;
